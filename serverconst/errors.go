...
var (
	...
	VErrOwnerIdNotProvided    = "Validation Error: owner id is required and was not provided"
	VErrManagerIdNotProvided  = "Validation Error: manager id is required and was not provided"
	VErrTimeWasZero           = "Validation Error: start time or end time is zero"
	VErrTimeWasGreater        = "Validation Error: start time is greater than end time"
	VErrPhotoNotProvided      = "Validation Error: no photo was provided"
	VErrParkingTermsLimit     = "Validation Error: parking terms do not accept more than 255 character"
	VErrWrongDoingNotProvided = "Validation Error: no wrong doing was provided"
